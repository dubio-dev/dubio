...
def main():
    ...
    os.system("python /root/lyricsgeneration/robust_lyrics_gen.py /root/lyricsgeneration/visemes_resonite_min_short.json /root/lyricsgeneration/output_lyrics.json --topic 'basic math'")
